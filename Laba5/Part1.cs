...
namespace Laba5
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Number of colums: ");
            columns = int.Parse(Console.ReadLine());

            Console.WriteLine("Lowest border of random numbers: ");
            firstArg = int.Parse(Console.ReadLine());

            Console.WriteLine("Highest border of random numbers: ");
            secondArg = int.Parse(Console.ReadLine());

            MyMatrix newMat = new MyMatrix(lines,columns, firstArg,secondArg);
            newMat.Show();

            Console.WriteLine("Let's change size of matrix: ");
